...
<article id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?>>
	...
	if ( isset( $ela_content_width ) && "" != $ela_content_width ) {
		if ( $ela_content_width == "wide" ) {
			$GLOBALS['content_width'] = 880;
			$ela_post_banner          = 'ela_wide_banner';
		} else if ( $ela_content_width == "grid" || $ela_content_width == 'two_coloumns_list' ) {
			$GLOBALS['content_width'] = 415;
			$ela_post_banner          = 'alia_grid_banner_tablet';
			if (
    ...
    <div class="post_body <?php echo esc_attr( $post_banner_class ); ?>">
        ...
        <div class="post_info_wrapper">
			<?php if ( is_single( get_the_ID() ) ||
				...
				if ( $ela_content_width == 'two_coloumns_list' || $ela_content_width == 'grid' || $ela_content_width == 'grid3col' ) {
					echo ela_excerpt( 20 );
				} else {
					if ( ! isset( $ela_content_layout ) || $ela_content_layout != 'layout_with_sidebar' ) {
						echo ela_excerpt( 40 );
					}
				}
